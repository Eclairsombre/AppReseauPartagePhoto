...
public class AlbumService {
    ...
    public Optional<Album> getAlbumIfAccessible(Long albumId, Long userId) {
        ...
        // Pour l'instant, seul le propriétaire peut voir ses albums
        // On pourrait étendre avec un système de partage d'albums
        return Optional.empty();
    }
    ...
    public void deleteAlbum(Long albumId, Long userId) {
        ...
        // Supprimer les liaisons album-photo
    ...
    public void addPhotoToAlbum(Long albumId, Long photoId, Long userId) {
        ...
        // Vérifier que la photo existe et que l'utilisateur peut y accéder
        ...
        // Vérifier que la photo n'est pas déjà dans l'album
